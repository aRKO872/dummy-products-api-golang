...
func (o *DeleteProductReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /product/{id}] deleteProduct", response, response.Code())
	}
}
...
func (o *DeleteProductOK) Error() string {
	return fmt.Sprintf("[DELETE /product/{id}][%d] deleteProductOK", 200)
}
...
func (o *DeleteProductNotFound) Error() string {
	...
	return fmt.Sprintf("[DELETE /product/{id}][%d] deleteProductNotFound %s", 404, payload)
}
...
DeleteProductInternalServerError delete product internal server error
*/
...
func (o *DeleteProductInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /product/{id}][%d] deleteProductInternalServerError %s", 500, payload)
}
