...
type ClientService interface {
	CreateProducts(params *CreateProductsParams, opts ...ClientOption) (*CreateProductsOK, error)
	...
	UpdateProducts(params *UpdateProductsParams, opts ...ClientOption) (*UpdateProductsOK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
CreateProducts Create new products and add to list of products
*/
func (a *Client) CreateProducts(params *CreateProductsParams, opts ...ClientOption) (*CreateProductsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCreateProductsParams()
	}
	op := &runtime.ClientOperation{
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &CreateProductsReader{formats: a.formats},
	...
	success, ok := result.(*CreateProductsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for createProducts: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
DeleteProduct Delete Product for given ID
*/
...
/*
UpdateProducts Update Product from the list and returns an updated list of products
*/
func (a *Client) UpdateProducts(params *UpdateProductsParams, opts ...ClientOption) (*UpdateProductsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
